...
const DEFAULT_DATA = {
  meta: {
    ...
    /* ფონტის თემა: editorial (default) · minimal · mono · classic. იცვლება "✎ ტექსტები"-ში */
    fontTheme: "editorial",
    /* Works გვერდი: false = ბადე (grid) · true = თავისუფალი განლაგება (free-move canvas) */
    worksFree: false,
  ...
  /* ---- WORKS CANVAS TEXT BLOCKS ------------------------------------
     თავისუფალ განლაგებაში (worksFree) ნამუშევრებს შორის ჩასმული ტექსტები.
     თითო: { id, text, pos:{xPct,y,wPct} }. იმართება Works გვერდზე admin-ში.
     ----------------------------------------------------------------- */
  canvasTexts: [],
